...
'
' ASCOM Switch driver for GBOFlat
'
...
'
'
' Your driver's ID is ASCOM.GBOFlat.Switch
'
...
<Guid("45cd23e0-ca1d-4f36-b95f-17b5a90bb532")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Switch

    ' The Guid attribute sets the CLSID for ASCOM.GBOFlat.Switch
    ' The ClassInterface/None addribute prevents an empty interface called
    ' _GBOFlat from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.GBOFlat.Switch"
    Private Shared driverDescription As String = "GBOFlat Switch"
